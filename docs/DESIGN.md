...
> Design notes for **fieldservice-error-capture-go** — a runnable go example that Capture and group work-order photo failures with dispatch context in Go.
...
- **Feature code** — the actual task: field-service-error-tracking.
